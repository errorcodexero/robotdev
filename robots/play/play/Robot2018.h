...
protected:
    ...
    {
	std::shared_ptr<Robot2018Operator> ctrl_p = std::make_shared<Robot2018Operator>(*this) ;
	return ctrl_p ;
    }
...
private:
    ...
    static const std::string ParamStraightSwitchThreshold;
    static const std::string ParamAngleThreshold;
    static const std::string ParamAngleSwitchThreshold;
    ...
    static double DistanceSwitchThreshold;
    static double AngleThreshold;
    static double AngleSwitchThreshold;
